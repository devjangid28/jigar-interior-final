      ...
      <div className="sidemenu__panel">
        ...
        <div className="sidemenu__contact">
          <div className="sidemenu__contact-header">
            <a href="https://wa.me/919724441259" target="_blank" rel="noopener noreferrer" className="button-round --outline sidemenu__whatsapp">
          ...
          <ul className="sidemenu__contact-list">
            ...
            <li>
              ...
              <div className="sidemenu__contact-content">
                <a href="https://wa.me/919724441259" target="_blank" rel="noopener noreferrer">+91 9724441259</a>
              </div>
            </li>
            <li>
